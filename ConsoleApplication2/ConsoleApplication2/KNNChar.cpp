...
std::string KNNChar::recognizeCharacter(cv::Mat testImage) {
	...
	cv::Mat matTestingNumbers = testImage;//cv::imread("2.png");            // read in the test numbers image
    ...
    //cv::waitKey(0);                                         // wait for user key
